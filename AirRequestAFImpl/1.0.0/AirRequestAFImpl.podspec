...
Pod::Spec.new do |s|
  # pod基本描述信息
  s.name               = "AirRequestAFImpl"                                  # Pod的名称
  s.version            = "1.0.0"                                             # Pod版本号
  s.summary            = "A AirRequest implementation with AFNetworking"     # pod的简短介绍，下面是详细介绍
  s.description        = <<-DESC
                        Use AFNetworking to implementation AirRequest.
                        DESC
  s.homepage           = "https://www.jyblife.com"        # 项目主页,这里要填写可以访问到的地址，不然验证不通过
  # s.screenshots        = "www.example.com/screenshots_1", "www.example.com/screenshots_2"    # 截图
  s.license            = 'MIT'               # 开源协议
  s.author             = { "luochenxun" => "luochenxun@gmail.com" }            # 作者信息
  s.source             = { :git => "http://git.jtjr.com/chauncey/AirRequestAFImpl.git", :tag => "#{s.version}" }   # 项目地址
