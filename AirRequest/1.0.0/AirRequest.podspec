...
Pod::Spec.new do |s|
  # pod基本描述信息
  s.name               = "AirRequest"                              # Pod的名称
  s.version            = "1.0.0"                                   # Pod版本号
  s.summary            = "Basic network lib of AirOne"     # pod的简短介绍，下面是详细介绍
  s.description        = <<-DESC
                        AirOne网络基础库
                        DESC
  ...
  s.source             = { :git => "http://git.jtjr.com/chauncey/AirRequest.git", :tag => "#{s.version}" }   # 项目地址
